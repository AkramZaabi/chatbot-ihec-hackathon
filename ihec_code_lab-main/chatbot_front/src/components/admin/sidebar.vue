      ...
      <ul>
        ...
        <li>
          <a @click="changerView('stat')" href="#" :class="store.view == 'stat' ? 'active' : ''">
            ...
            <span :class="small ? 'none_btn_open_close_sidebar' : ''" class="nav-item">Statics</span>
          </a>
        </li>
        <li >
          <a @click="changerView('Responses')" href="#" :class="store.view == 'Responses' ? 'active' : ''">
            <v-icon class="icon">mdi-account-supervisor</v-icon>
            <span :class="small ? 'none_btn_open_close_sidebar' : ''" class="nav-item">Responses</span>
          </a>
        </li>
        <li v-if="test_ischef == true ">
          <a @click="changerView('FeedBack')" href="#" :class="store.view == 'FeedBack' ? 'active' : ''">
            <v-icon class="icon">mdi-account-cog</v-icon>
            <span :class="small ? 'none_btn_open_close_sidebar' : ''" class="nav-item">FeedBack</span>
          </a>
        </li>
